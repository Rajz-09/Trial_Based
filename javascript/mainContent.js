...
async function checkSubscriptionStatus() {
    try {
        const data = await fetchWithAuth("https://swarparivritti-backend.onrender.com/api/checkSubscription");
...
async function fetchStoredConvertCount() {
    try {
        ...
        const data = await fetchWithAuth("https://swarparivritti-backend.onrender.com/api/increment-convert", "POST", { email });
