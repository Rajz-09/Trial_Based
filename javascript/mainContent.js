...
async function checkSubscriptionStatus() {
    try {
        const data = await fetchWithAuth("https://www.swarprivritti.com/api/checkSubscription");
...
async function fetchStoredConvertCount() {
    try {
        ...
        const data = await fetchWithAuth("https://www.swarprivritti.com/api/increment-convert", "POST", { email });
