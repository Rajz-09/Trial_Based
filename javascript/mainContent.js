...
async function checkSubscriptionStatus() {
    try {
        const data = await fetchWithAuth("http://swarparivrittitrial.vercel.app/api/checkSubscription");
...
async function fetchStoredConvertCount() {
    try {
        ...
        const data = await fetchWithAuth("http://swarparivrittitrial.vercel.app/api/increment-convert", "POST", { email });
