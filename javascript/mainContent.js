...
async function checkSubscriptionStatus() {
    try {
        const data = await fetchWithAuth("http://localhost:5000/api/checkSubscription");
...
async function fetchStoredConvertCount() {
    try {
        ...
        const data = await fetchWithAuth("http://localhost:5000/api/increment-convert", "POST", { email });
