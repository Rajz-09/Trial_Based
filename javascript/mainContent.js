...
async function checkSubscriptionStatus() {
    try {
        const data = await fetchWithAuth("https://swarparivritti-trial.vercel.app/api/checkSubscription");
...
async function fetchStoredConvertCount() {
    try {
        ...
        const data = await fetchWithAuth("https://swarparivritti-trial.vercel.app/api/increment-convert", "POST", { email });
